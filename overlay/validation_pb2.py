...
_VALIDATIONMETRIC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='classification_response', full_name='ValidationMetric.classification_response', index=0,
